(module
  ...
  (func $_start (type 9)
    ...
    block  ;; label = @1
      block  ;; label = @2
        ...
        i32.const 0
        i32.const 1
        i32.atomic.rmw.cmpxchg offset=3856
        br_if 0 (;@2;)
        call $__wasi_init_tp
    ...
    unreachable)
  (func $thread_function (type 2) (param i32) (result i32)
  ...
  (func $printf_core (type 11) (param i32 i32 i32 i32 i32) (result i32)
    (local i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i64 i64 f64 i32 i32 i32 i32 i32 i32 i32 i32 f64)
    global.get $__stack_pointer
    i32.const 880
    i32.sub
    local.tee 5
  ...
  (func $dlmalloc (type 2) (param i32) (result i32)
    ...
    block  ;; label = @1
      ...
      block  ;; label = @2
        i32.const 0
        i32.const 1
        i32.atomic.rmw.xchg offset=5460
        i32.eqz
        br_if 0 (;@2;)
        i32.const 1
        local.set 2
      ...
      block  ;; label = @2
        ...
        i64.store offset=4964 align=4
        i32.const 0
        i64.const 2
        i64.store offset=5428 align=4
        i32.const 0
        local.get 1
        i32.const 4
        i32.add
      ...
      i32.const 0
      i32.const 0
      i32.atomic.store offset=5460
    end
    block  ;; label = @1
      i32.const 0
      i32.load8_u offset=5428
      i32.const 2
      i32.and
      i32.eqz
      br_if 0 (;@1;)
      i32.const 0
      i32.const 1
      i32.atomic.rmw.xchg offset=5432
      i32.eqz
      br_if 0 (;@1;)
      i32.const 1
      local.set 2
              ...
              block  ;; label = @6
                block  ;; label = @7
                  block  ;; label = @8
                    ...
                    i32.add
                    i32.const 0
                    i64.load offset=5444 align=4
                    i64.store align=4
                    local.get 8
                    i32.const 0
                    i64.load offset=5436 align=4
  ...
  (func $__tl_unlock (type 9)
    ...
    loop  ;; label = @1
      ...
      local.get 0
      i32.const 0
      i32.atomic.rmw.cmpxchg offset=3864
      i32.ne
      br_if 0 (;@1;)
    end
    block  ;; label = @1
      ...
      i32.const 0
      i32.const 1
      memory.atomic.notify offset=3864
      drop
    end)
  ...
  (func $wasi_thread_start (type 16) (param i32 i32)
    ...
    drop)
  (table (;0;) 6 6 funcref)
  (global $__stack_pointer (mut i32) (i32.const 71024))
  ...
  (elem (;0;) (i32.const 1) func $thread_function $__stdio_write $__stdio_close $__stdout_write $__stdio_seek)
